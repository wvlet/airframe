...
When running test codes, you can also use `src/test/resources/log-test.properties` file to configure log levels.
See [wvlet-log configuration](https://github.com/wvlet/log#configuring-log-levels) for the details.
