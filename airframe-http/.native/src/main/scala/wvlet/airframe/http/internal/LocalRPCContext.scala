...
/**
  * Thread-local RPC context management for Scala Native.
  *
  * This implementation mirrors the JVM LocalRPCContext using ThreadLocal, which is supported in Scala Native.
  */
