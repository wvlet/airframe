...
/**
  ...
  */
private[airspec] class AirSpecRunnerSbt(config: AirSpecConfig, val remoteArgs: Array[String], classLoader: ClassLoader)
...
private[airspec] object AirSpecRunnerSbt extends LogSupport {
  def newRunner(args: Array[String], remoteArgs: Array[String], testClassLoader: ClassLoader): AirSpecRunnerSbt = {
    new AirSpecRunnerSbt(AirSpecConfig(args), remoteArgs, testClassLoader)
  }
