...
trait PropertyCheck extends Asserts { this: AirSpecSpi =>
  ...
  private def booleanProp = { x: Boolean =>
    Prop(x)
  }

  def forAll[A1, U](checker: A1 => U)(implicit
                                      a1: Arbitrary[A1],
                                      s1: Shrink[A1],
                                      pp1: A1 => Pretty): Unit = {
  ...
  def forAll[A1, A2, U](checker: (A1, A2) => U)(implicit
                                                a1: Arbitrary[A1],
                                                s1: Shrink[A1],
                                                pp1: A1 => Pretty,
                                                a2: Arbitrary[A2],
  ...
  def forAll[A1, A2, U](g1: Gen[A1], g2: Gen[A2])(checker: (A1, A2) => U)(implicit
                                                                          s1: Shrink[A1],
                                                                          pp1: A1 => Pretty,
                                                                          s2: Shrink[A2],
                                                                          pp2: A2 => Pretty): Unit = {
  ...
  def forAll[A1, A2, A3, U](checker: (A1, A2, A3) => U)(implicit
                                                        a1: Arbitrary[A1],
                                                        s1: Shrink[A1],
                                                        pp1: A1 => Pretty,
                                                        a2: Arbitrary[A2],
