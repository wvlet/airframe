...
val SCALA_3             = sys.env.getOrElse("SCALA_VERSION", "3.3.6")
  ...
  project
    ...
    .settings(
      ...
      libraryDependencies ++= Seq(
        ...
        "io.swagger.parser.v3" % "swagger-parser" % "2.1.28" % Test,
  ...
  project
    ...
    .settings(
      ...
      libraryDependencies ++= Seq(
        ...
        "com.fasterxml.jackson.datatype" % "jackson-datatype-json-org" % "2.19.0" % Provided,
        "com.fasterxml.jackson.datatype" % "jackson-datatype-jdk8"     % "2.19.0" % Provided,
  ...
  project
    ...
    .settings(
      ...
      libraryDependencies ++= Seq(
        ...
        "software.amazon.awssdk" % "auth"       % "2.30.38" % Provided,
