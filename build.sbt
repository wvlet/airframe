  ...
  project
    ...
    .settings(
      ...
      libraryDependencies ++= Seq(
        ...
        "io.swagger.parser.v3" % "swagger-parser" % "2.1.32" % Test,
  ...
  project
    ...
    .settings(
      ...
      libraryDependencies ++= Seq(
        ...
        "com.fasterxml.jackson.datatype" % "jackson-datatype-json-org" % "2.19.2" % Provided,
        "com.fasterxml.jackson.datatype" % "jackson-datatype-jdk8"     % "2.19.2" % Provided,
  ...
  project
    ...
    .settings(
      ...
      libraryDependencies ++= Seq(
        ...
        "software.amazon.awssdk" % "auth"       % "2.31.49" % Provided,
