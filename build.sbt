...
val FINAGLE_VERSION                 = "22.1.0"
val FLUENCY_VERSION                 = "2.6.1"
val GRPC_VERSION                    = "1.43.2"
  ...
  project
    ...
    .settings(
      ...
      libraryDependencies ++= Seq(
        ...
        "io.swagger.parser.v3" % "swagger-parser" % "2.0.29" % Test,
  ...
  project
    ...
    .settings(
      ...
      libraryDependencies ++= Seq(
        ...
        "software.amazon.awssdk" % "auth"       % "2.17.113" % Provided,
