...
val AIRSPEC_VERSION                 = "22.4.1"
val SCALACHECK_VERSION              = "1.16.0"
val MSGPACK_VERSION                 = "0.9.1"
  ...
  project
    ...
    .settings(
      ...
      libraryDependencies ++= Seq(
        ...
        "io.swagger.parser.v3" % "swagger-parser" % "2.0.32" % Test,
  ...
  project
    ...
    .settings(
      ...
      libraryDependencies ++= Seq(
        ...
        "org.apache.hadoop"  % "hadoop-client"  % "3.3.2" % Provided,
        // For S3 support
        "org.apache.hadoop"      % "hadoop-aws" % "3.3.2"    % Provided,
        "software.amazon.awssdk" % "auth"       % "2.17.123" % Provided,
