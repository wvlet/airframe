  ...
  project
    ...
    .settings(
      ...
      libraryDependencies ++= Seq(
        ...
        "io.swagger.parser.v3" % "swagger-parser" % "2.1.37" % Test,
...
lazy val netty =
  project
    ...
    .settings(
      ...
      libraryDependencies ++= Seq(
        "io.netty" % "netty-all" % "4.2.10.Final"
      )
    )
  ...
  project
    ...
    .settings(
      ...
      libraryDependencies ++= Seq(
        ...
        "com.fasterxml.jackson.datatype" % "jackson-datatype-jdk8"     % JACKSON_VERSION % Provided,
